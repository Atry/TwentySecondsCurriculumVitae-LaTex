...
\aboutme{
	Yang Bo is a developer who knows how to create application frameworks.
	He founded \textit{Binding.scala} that can compile HTML or FXML templates to monadic GUI, and made it be the most popular framework in Scala.js.
	He also founded \textit{DeepLearning.scala} and \textit{Compute.scala} for creating neural networks from functional programming constructs.
	His recent framework \textit{Dsl.scala} allows customizing language features in libraries. He had ported \lstinline{async}/\lstinline{await} and \lstinline{yield} from C\#, RAII from C++, \lstinline{fork} from POSIX and \lstinline{!}-notation from Idris to Scala with \textit{Dsl.scala}.
	Yang Bo, as a technical leader, developed 战国风云 and other cash-cow products, but he now becomes a full-time developer for ThoughtWorks sponsored open-source projects.
...
\skillstext{{Scala.js/5.5},{Haxe/5.5},{OpenCL/5},{C++/4},{Java/4},{JavaScript/4},{DevOps/4},{Testing/3},{C/3},{Spark/3},{Akka/3}}
...
\begin{twenty}
	\twentyitem{2018-present}{\href{https://github.com/ThoughtWorksInc/Dsl.scala}{Dsl.scala}}{Scala}{is a framework to extend Scala language features in libraries.}
	...
	\twentyitem{2007-present}{\href{https://github.com/search?o=desc&q=+user\%3Aatry+user\%3Athoughtworksinc+committer\%3Aatry&s=stars&type=Repositories}{other hundreds of open-source projects}}{}{}
\end{twenty}
